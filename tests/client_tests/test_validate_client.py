...
def test_validate_client():
    ...
    valid_client = Client.create_client(1, 'Vasile Pop', 5030122111222, 2012)
    ...
    wrong_name_client = Client.create_client(1, 'Vasile-alexandru pOp', 5030122111222, 2009)
    try:
    ...
    wrong_cnp_client = Client.create_client(1, 'Vasile Pop', '5021c1', 2009)
    try:
    ...
    wrong_subscription_year_client = Client.create_client(1, 'Vasile Pop', 5030222111222, 1922)
    try:
    ...
    same_id_client = Client.create_client(1, 'Ion X', 5030101111222, 1987)
    try:
